...
Przeszkoda1::Przeszkoda1(vector3d pozycja, std::string wczytanie_przeszkoda1, std::string zapis_przeszkoda1, vector3d _skala)
{
    this->orientacja = matrix3d();
    this->srodek = pozycja;
    this->czyt_wierzcholki = wczytanie_przeszkoda1;
    this->zapis_wierzcholkow = zapis_przeszkoda1;
    this->skala = _skala;

}


void Przeszkoda1::czyt_wierzcholki_z_pliku()
{
 ...
 * 
 */
void Przeszkoda1::szukanie_pozycji()
{
...
std::string Przeszkoda1::jaka_przeszkoda()
{
    return std::string("przeszkoda1");
}
